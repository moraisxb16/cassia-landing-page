    ...
    <section className="hero-section relative overflow-hidden cassia-hero-gradient min-h-screen flex items-center justify-center">
      ...
      <div className="container mx-auto px-4 relative" style={{ zIndex: 1 }}>
        <div className="hero-content max-w-4xl mx-auto text-center flex flex-col items-center">
          ...
          <motion.h2
            className="hero-headline text-center mb-3 text-[22px] md:text-[36px] md:mb-8"
            style={{
              fontWeight: 700,
              color: '#FFFFFF',
            }}
          ...
          <motion.h2
            className="hero-subheadline text-center mb-4 text-[18px] md:text-[28px] md:mb-10"
            style={{
              color: '#FFFFFF',
            }}
          ...
          <motion.p
            className="hero-description-text text-center mb-6 text-[14px] md:text-[20px] md:mb-12"
